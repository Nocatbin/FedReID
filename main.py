...
parser.add_argument('--train_all', action='store_true', help='use all training data, default false')
...
parser.add_argument('--multi', action='store_true', help='use multiple query, default false')
...
# exec action if argument is annotated
